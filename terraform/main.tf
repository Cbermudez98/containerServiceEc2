...
#   name = "${var.environment}-ecs-task-container-execution-role"
...
#   name = "${var.environment}-ecs-task-container-role"
#   assume_role_policy = jsonencode({
#     Version = "2012-10-17"
#     Statement = [
#       {
...
#   name = "${var.environment}-ecs-instance-container-profile"
...
#   name        = "${var.environment}-container-nestjs-tg"
#   port        = 80
#   protocol    = "HTTP"
#   vpc_id      = aws_vpc.main.id
#   target_type = "ip"
...
#   name               = "${var.environment}-nestjs-container-alb"
#   internal           = false
